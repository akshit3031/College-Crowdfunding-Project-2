      ...
      <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-3">
              <CustomButton
                btnType="button"
                title="Add Teacher"
                styles="bg-green-600 hover:bg-green-700 text-white px-6 py-2"
        ...
        <div className="bg-white border-2 border-[#DCDCDC] rounded-[15px] p-6">
          ...
          <div className="space-y-3 text-gray-600">
            ...
            <ul className="list-disc list-inside space-y-1 text-[12px] ml-4">
            ...
            <p className="font-epilogue font-normal text-[14px] mt-4">
